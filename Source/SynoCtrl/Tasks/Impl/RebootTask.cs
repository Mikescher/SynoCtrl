...
{
	public class RebootTask : SCTask
	{
		protected override int Execute()
		{
			...
			SynologyAPI.Reboot(config.Selected.IPAddressRaw, config.Selected.Port ?? -1, config.Selected.UseTLS, config.Selected.Username, config.Selected.Password);
